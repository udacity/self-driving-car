...
namespace NeuralNetwork {
	namespace ProblemSets {
		...
		std::vector<TrainingPattern> And(float min = 0.0) {
			return {{{min,1},{min}},{{1,min},{min}},{{1,1},{1}},{{min,min},{min}}};
		}

		std::vector<TrainingPattern> Or(float min = 0.0) {
			return {{{min,1},{1}},{{1,min},{1}},{{1,1},{1}},{{min,min},{min}}};
		}

		std::vector<TrainingPattern> Xor(float min = 0.0) {
			return {{{min,1},{1}},{{1,min},{1}},{{1,1},{min}},{{min,min},{min}}};
		}
	}
}